...
import ai.chatur.cortex.spring.lint.LintConfiguration;
 ...
 *
 * <p>Assembles a ready-to-use {@link Cortex} knowledge graph from the ontology, lint, ingest,
 * query, and inference configurations, driven by the {@code cortex.*} {@link CortexProperties
 * properties}.
 */
@Configuration
...
public class CortexConfiguration {
  ...
  Cortex cortex(
    ...
    return new JenaCortex(
        ontologyService, lintService, ingestService, inferenceService, queryService, statsService);
  }
}
